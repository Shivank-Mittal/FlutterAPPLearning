...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Emplyee Text'),),
      body: Container(
        child: StreamBuilder<List<Emplyee>>(
          stream: _employeeBloc.employeeListStream,
          builder:  (BuildContext context, AsyncSnapshot<List<Emplyee>> snapshot)
          {
